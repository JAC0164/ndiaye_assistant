...
export const generatedSeanceSchema = z.object({
  ...
  session_type: z.enum(["review"]),
  pedagogical_note: z
    .string()
    .describe("Note pédagogique courte pour guider la séance."),
})
...
export type PlanningGraphAnnotationState =
  typeof PlanningGraphAnnotation.State

export type PlanningGraphAnnotationUpdate =
  typeof PlanningGraphAnnotation.Update
